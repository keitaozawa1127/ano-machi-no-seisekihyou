...
import { ExtendedMetrics } from "../../../lib/mlitApi";
...
async function diagnoseAsync(stationNameRaw: string, prefCodeRaw: string, yearRaw: number): Promise<DiagnoseOkResponse | DiagnoseNgResponse> {
    try {
